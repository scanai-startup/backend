...
public class DepositoMostroController {
    ...
    @Transactional
    public ResponseEntity<DadosDetalhamentoDepositoMostro> newDepositomostro(@RequestBody @Valid DadosCadastroDepositoMostro data, UriComponentsBuilder uriBuilder){
